...
function after_execute_test_scenario() {
    ...
    download_file "$wso2is_1_host_alias" $is_home/repository/logs/diagnostics.log "diagnostics_1.log"
    ...
    download_file "$wso2is_1_host_alias" $is_home/repository/logs/diagnostics.log "diagnostics_2.log"
}
