...
function after_execute_test_scenario() {
    ...
    download_file "$wso2is_1_host_alias" $is_home/repository/logs/diagnostics.log $wso2is_1_host_alias"_diagnostics.log"
    ...
    download_file "$wso2is_2_host_alias" $is_home/repository/logs/diagnostics.log $wso2is_2_host_alias"_diagnostics.log"
}
