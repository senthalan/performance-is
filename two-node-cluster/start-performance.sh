...
echo "-----------------"
aws cloudformation describe-stack-resources --stack-name "$stack_id" --logical-resource-id WSO2BastionInstance"$random_number"
echo "-----------------"
aws ec2 describe-instances --instance-ids "$bastion_instance"
echo "-----------------"
